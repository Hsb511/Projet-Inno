<?php
    ...
    $profiles = array(
        ...
        "1"  => array("firstName" =>"Véronique", "lastName" => "Gentil", "address" => "30 avenue du bois 75000 Paris", "birthdate" => "1970-06-12", "type" => "helped", "helpedBy"=> array(), "announces" => array("0")),
        "2"  => array("firstName" =>"Maxime", "lastName" => "Petit", "address" => "14 rue du champs 50214 Dufour", "birthdate" => "1997-04-12", "type" => "helper", "helps" => array(), "announces" => array("0")),
    );
?>